...
class URLSessionHTTPClientThirdApproach {
 ...
 class URLSessionHTTPClientTestsThirdApproach: XCTestCase {
//     redundant
...
//     }
     ...
     func test_getFromURL_resumeDataTaskWithURL() {
         ...
         let sut = URLSessionHTTPClientThirdApproach(session: session)
